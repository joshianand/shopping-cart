					...
					<div class="top_section">
						...
						<div class="right_content">
							<div class="left_arrow">
								<a href="#"><img src="<?php echo $html; ?>/img/left_arrow.png" alt=""></a>
							</div>
							<div class="slider_img">						
								<img src="<?php echo $html; ?>/img/slider_img1.png" alt="">		
								<img src="<?php echo $html; ?>/img/slider_img2.png" alt="">		
							</div>
							<div class="right_arrow">
								<a href="#"><img src="<?php echo $html; ?>/img/right_arrow.png" alt=""></a>
							</div>
							<br class="clear">
						</div>
						<br class="clear">
