...
<?php $html = get_template_directory_uri(''); ?>					
					...
					<section class="marketing">
						<div class="section_container">
							...
							<div class="marketing_bottom_section">
								<div class="bottom_img">
									<div class="marketing_section_tabs">
										<a href=""><img src="<?php echo $html; ?>/img/seo.png" alt=""></a>
									</div>
									<div class="marketing_section_tabs">
										<a href=""><img src="<?php echo $html; ?>/img/sea.png" alt=""></a>
									</div>		
									<div class="marketing_section_tabs">
										<a href=""><img src="<?php echo $html; ?>/img/memail.png" alt=""></a>
									</div>
									<br class="clear">	
								</div>
